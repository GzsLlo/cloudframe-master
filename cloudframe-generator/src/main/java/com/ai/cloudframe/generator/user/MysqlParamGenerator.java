...
public class MysqlParamGenerator {
    ...
    private static final String module = "com.ai.cloudframe.provider.param";
    private static final String projectPath = "/cloudframe-provider/cloudframe-provider-param";
